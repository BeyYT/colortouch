  ...
  (function(evtTools2) {
    ...
    (function(p2p2) {
      ...
      p2p2.sendVariableTo = (id, eventName, variable) => {
        p2p2.sendDataTo(id, eventName, gdjs2.evtTools.network.variableStructureToJSON(variable));
      };
      p2p2.sendVariableToAll = (eventName, variable) => {
        p2p2.sendDataToAll(eventName, gdjs2.evtTools.network.variableStructureToJSON(variable));
      };
      ...
      p2p2.getEventVariable = (eventName, variable) => {
        gdjs2.evtTools.network.jsonToVariableStructure(p2p2.getEventData(eventName), variable);
      };
